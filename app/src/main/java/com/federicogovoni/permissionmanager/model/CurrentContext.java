package com.federicogovoni.permissionmanager.model;
...
import static com.federicogovoni.permissionmanager.view.fragment.SettingsFragment.RECEIVE_NOTIFICATION_SHARED_PREFERENCE;
...
public class CurrentContext implements Serializable {
    ...
    private void showNotification(String message, Context context, int id) {
        ...
        boolean receiveNotifications = PreferenceManager.getDefaultSharedPreferences(context.getApplicationContext()).getBoolean(RECEIVE_NOTIFICATION_SHARED_PREFERENCE, true);
