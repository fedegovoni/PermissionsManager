...
package com.federicogovoni.permissionmanager.billing;
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    logDebug("Checking for in-app billing 3 purchase_pro.");

                    // check for in-app billing v3 purchase_pro
                    int response = mService.isBillingSupported(3, packageName, ITEM_TYPE_INAPP);
                    if (response != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(new IabResult(response,
                                "Error checking for billing v3 purchase_pro."));
                    ...
                    // Check for v5 subscriptions purchase_pro. This is needed for
                    ...
                    if (mSubscriptionUpdateSupported) {
                        ...
                        // check for v3 subscriptions purchase_pro
